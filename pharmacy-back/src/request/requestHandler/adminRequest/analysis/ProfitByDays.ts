...
export default class ProfitByDays extends RequestHandler{
    ...
    handle(req: any, res: any): void {
            ...
            this.pool.query(query,[date,enddate]).then((result:any)=>res.json({list:result,startDate:date,enddate,total:result.reduce((a:any,b:any)=>({profit: a.profit+b.profit}))['profit']}))
