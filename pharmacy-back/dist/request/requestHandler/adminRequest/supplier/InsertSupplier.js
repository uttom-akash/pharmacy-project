...
var InsertSupplier = /** @class */ (function (_super) {
    __extends(InsertSupplier, _super);
    function InsertSupplier() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    InsertSupplier.prototype.handle = function (req, res) {
        var _this = this;
        var _a = req.body, supplierName = _a.supplierName, mobileNo = _a.mobileNo, address = _a.address;
        var query = "insert into Supplier values(?,?,?,?)";
        this.UniqueID().then(function (ID) { return _this.pool.query(query, [ID, supplierName, mobileNo, address])
            .then(function (result) { return res.json({ result: result }); })
            .catch(function (err) { return res.json({ error: err }); }); });
    };
    InsertSupplier.prototype.getUserID = function () {
        return Hash256_1.default.getInstance().execute(RandomGenerator_1.default.getInstance().getNumber());
    };
    InsertSupplier.prototype.UniqueID = function () {
        return __awaiter(this, void 0, void 0, function () {
            var query, unique, user_id, id;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        query = "select count(*) as id FROM Supplier where SUPPLIER_ID=?";
                        unique = true;
                        user_id = "";
                        _a.label = 1;
                    case 1:
...
exports.default = InsertSupplier;
