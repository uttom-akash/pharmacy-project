...
var Register = /** @class */ (function (_super) {
    ...
    Register.prototype.handle = function (req, res) {
        var _this = this;
        var _a = req.body, FirstName = _a.FirstName, LastName = _a.LastName, address = _a.address, phoneNumber = _a.phoneNumber, password = _a.password;
        var qs = "insert into Users(ADMIN_ID,FIRST_NAME,LAST_NAME,ADDRESS,CONTACT_NUMBER,PASSWORD) values(?,?,?,?,?,?)";
        var passwordhash = Hash256_1.default.getInstance().execute(password);
        this.UniqueID().then(function (adminID) { return _this.pool.query(qs, [adminID, FirstName, LastName, address, phoneNumber, passwordhash])
    ...
    Register.prototype.UniqueID = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        query = "select count(*) as id FROM Admin where ADMIN_ID=?";
                        unique = true;
                        user_id = "";
                        _a.label = 1;
                    case 1:
