...
var Register = /** @class */ (function (_super) {
    ...
    Register.prototype.handle = function (req, res) {
        var _this = this;
        var _a = req.body, FirstName = _a.FirstName, LastName = _a.LastName, salary = _a.salary, nid = _a.nid, phoneNumber = _a.phoneNumber, address = _a.address, ref_name = _a.ref_name, ref_num = _a.ref_num;
        var qs = "insert into Users(EMPLOYEE_ID,FIRST_NAME,LAST_NAME,SALARY,NID,MOBILE_NO,ADDRESS,REF_NAME,REF_NUM) values(?,?,?,?,?,?,?,?,?)";
        this.UniqueID().then(function (EmployeeID) { return _this.pool.query(qs, [EmployeeID, FirstName, LastName, salary, nid, phoneNumber, address, ref_name, ref_num])
    ...
    Register.prototype.UniqueID = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        query = "select count(*) as id FROM Employee where EMPLOYEE_ID=?";
                        unique = true;
                        user_id = "";
                        _a.label = 1;
                    case 1:
