        ...
        this.getCategories().then(function (categoryList) {
            var drugs = categoryList.map(function (category) {
                return _this.getDrugsID(category["CATEGORY_ID"]).then(function (drugsIDList) {
                    ...
                    return Promise.all(categoryDrugs).then(function (categoryDrugsList) { return ({ CATEGORY: category["CATEGORY_NAME"], CATEGORY_ID: category["CATEGORY_ID"], DRUGS: categoryDrugsList }); });
                });
            });
